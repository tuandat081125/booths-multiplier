...
Overview:
Implements an 8-bit signed multiplier using Booth's Algorithm in Verilog HDL.
...
Signed Addition
Signed Subtraction
Arithmetic right shifting is implemented across: (A, Q, Q-1)
to preserve sign extension during multiplication.
