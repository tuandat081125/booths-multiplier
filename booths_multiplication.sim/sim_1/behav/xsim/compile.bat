...
REM
REM Generated by Vivado on Thu Jun 18 21:23:18 +0700 2026
...
echo "xvlog --incr --relax -L uvm -prj booths_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj booths_tb_vlog.prj -log xvlog.log
